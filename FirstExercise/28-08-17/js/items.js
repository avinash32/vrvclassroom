...
var todoitems = (function(){
	...
	timeForNewToDoItem = function(newItem){
		...
		var stat = "unchecked";
		div.innerHTML = todoitem.template(newItem,checkBoxid,divId);
		ulContainer.appendChild(div);
		console.log("new TODO item added");
		var insertedItems = {id : checkBoxid, name : newItem, state : stat};
		todomain.storeElements(insertedItems);
	}
